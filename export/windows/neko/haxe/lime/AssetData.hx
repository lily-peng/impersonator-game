...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/data/default_auto.txt", "assets/data/default_auto.txt");
			type.set ("assets/data/default_auto.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			path.set ("assets/images/gardengnome.png", "assets/images/gardengnome.png");
			type.set ("assets/images/gardengnome.png", Reflect.field (AssetType, "image".toUpperCase ()));
