...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/gardengnome.png", __ASSET__assets_images_gardengnome_png);
		type.set ("assets/images/gardengnome.png", AssetType.IMAGE);
		...
		id = "assets/images/gardengnome.png";
		path.set (id, id);
...
@:keep class __ASSET__assets_images_gardengnome_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/gardengnome.png") class __ASSET__assets_images_gardengnome_png extends flash.display.BitmapData {}
